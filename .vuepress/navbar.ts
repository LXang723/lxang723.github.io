const navbar = [
  ...
  // 技术笔记
  {
    ...
    children: [
        ...
        children: [
          {
            ...
            link: "/series/tech/framework/spring/",
          },
      ...
      {
        text: "数据库",
        children: [{ text: "MySQL", link: "/series/tech/database/mysql/" }],
      },
      // {
      //     text: 'Java',
      //     icon: 'IconCoffee',
        ...
        children: [
          {
            ...
            icon: "IconDesignPattern",
          },
          {
            text: "项目经验",
            link: "/series/project-experience/",
            icon: "IconDesignPattern",
          },
          { text: "复习", icon: "IconList", link: "/series/interview/" },
        ],
      },
    ],
  },
